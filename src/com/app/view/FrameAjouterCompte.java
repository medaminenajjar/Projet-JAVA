...
public class FrameAjouterCompte {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameAjouterCompte window = new FrameAjouterCompte();
	...
	private void initialize() {
		frame = new JFrame("Ajouter Compte");
		...
		JLabel lblVosInformationsPersonnelles = new JLabel("Ajouter Compte");
		...
		lblNewLabel.setIcon(new ImageIcon("/root/samething/Projet/src/image/abstrait-abstract-background-vecteur-arrière-plan-forme-voile-1560x1103.jpg"));
		lblNewLabel.setBounds(0, 0, 598, 365);
