...
public class FrameSuppOperation {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameSuppOperation window = new FrameSuppOperation();
	...
	private void initialize() {
		frame = new JFrame("Supprime Operation");
		frame.setVisible(true);
		frame.setBounds(100, 100, 450, 230);
		frame.getContentPane().setLayout(null);
		
		JLabel lblAjouterUnOperation = new JLabel("Supprime une operation");
